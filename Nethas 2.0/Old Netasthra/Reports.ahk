...
Pause::
InputBox, Var, Reports Script, • SD Incident Distribution "inc" `n• SD Service Request "sr" `n• Misrouted Incidents "miss1" `n• Missrouted Service Request "miss2" `n• EUC Incident Distrubition "eucinc"`n• EUC Service Request "eucsr"`n• Agent State "state"`n• Queue Statistics "statistics"  `n• Queues by Agent "qagent"  `n• Chat Reports "chat"  `n• ScoreCard "reported" `n• KPI State Filter "state filter" `n• Statistics Filter "statistics filter" `n• Queues by Agent Filter "qagent filter" , , 250, 450
...
global
	...
	;send {PgDn 1}
	MouseClick, left, 2263, 256			;Click Anupam Agent Driven Abandon Chat Report
	sleep 100
	...
	send {PgDn 1}
	MouseClick, left, 2194, 190			;Click in Alex Agent Driven Resolved Chat
	MouseClick, left, 3705, 320			;Click in Show Additional Filters
	waitClick()
	MouseClick, left, 2244, 527
...
;	MouseClick, left, 3831, 271			;Temporarily
	MouseClick, left, 2210, 207			;Alex User and System Driven Abandoned Chat
	MouseClick, left, 3705, 320			;Click in Show Additional Filters
	waitClick()
	MouseClick, left, 2189, 568
	MouseClick, left, 2244, 527
