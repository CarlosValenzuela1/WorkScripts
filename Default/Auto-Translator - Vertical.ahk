...
send {ENTER}
sleep 4000
MouseClick, left, 69, 212   ; To select Spanish language
sleep 100
MouseClick, left, 239, 296  ; Click on left box to put text to be translated
sleep 500
send ^v			    ; Paste text to be translated
MouseClick, Left, 791, 216  ;Press Button "Translate"
sleep 500
MouseClick, left, 890, 353 ; First Click
sleep 500
MouseClick, left, 890, 353 ; Second Click (To highlight all text)
sleep 500
send ^c
sleep 50
send ^1
